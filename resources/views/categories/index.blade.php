<x-app-layout>
    ...
    @elseif($category->name == 'Segurança') bg-red-500/20 border-red-300/30 text-red-200
    ...
    border flex items-center justify-center shadow-lg">
                                    ...
                                    @elseif($category->name == 'Segurança')
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 3l7 4v5c0 5-3.5 8-7 9-3.5-1-7-4-7-9V7l7-4z" />
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M9.5 12l1.5 1.5L14.5 10" />
                                    </svg>
                                    @endif
