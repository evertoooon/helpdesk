        ...
        <div class="w-full max-w-md">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-blue-100 mt-3">
                    Acesse sua conta para acompanhar e gerenciar chamados.
                </p>
            ...
            <div class="bg-gradient-to-br from-white/15 to-white/5 backdrop-blur-xl rounded-3xl border border-white/15 shadow-2xl overflow-hidden">
                ...
                <form method="POST" action="{{ route('login') }}" class="p-6 space-y-6">
                    ...
                    <div>
                        <label for="email" class="block text-blue-100 mb-2 font-medium">
                            E-mail
                        </label>
                        ...
                        <input
                            ...
                            class="w-full rounded-2xl bg-white/10 border border-white/10 text-white placeholder:text-blue-200/50 focus:border-blue-400 focus:ring focus:ring-blue-500/20 transition">
                    ...
                    <div>
                        <label for="password" class="block text-blue-100 mb-2 font-medium">
                            Senha
                        </label>
                        ...
                        <input
                            ...
                            class="w-full rounded-2xl bg-white/10 border border-white/10 text-white placeholder:text-blue-200/50 focus:border-purple-400 focus:ring focus:ring-purple-500/20 transition">
                    ...
                    <div class="flex items-center justify-between gap-4">
                        ...
                        <label for="remember_me" class="inline-flex items-center">
                            ...
                            <span class="ms-2 text-sm text-blue-100">
                                Lembrar-me
                            </span>
                        </label>

                        @if (Route::has('password.request'))
                            <a href="{{ route('password.request') }}" class="text-sm text-blue-300 hover:text-white transition">
                                Esqueceu a senha?
                            </a>
                        @endif
                    ...
                    <button
                        type="submit"
                        class="w-full px-7 py-4 rounded-2xl bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 hover:scale-[1.02] transition text-white font-bold shadow-[0_0_30px_rgba(99,102,241,.35)]">
                    ...
                    @if (Route::has('register'))
                        <p class="text-center text-blue-100 text-sm">
                            ...
                            <a href="{{ route('register') }}" class="text-blue-300 hover:text-white font-semibold transition">
                                Criar conta
                            </a>
                        </p>
                    @endif
